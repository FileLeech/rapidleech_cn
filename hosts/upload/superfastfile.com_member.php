...
if ($superfastfile_login & $superfastfile_pass){
	...
	echo "<b><center>Ê¹ÓÃÄ¬ÈÏµÄÓÃ»§Ãû/ÃÜÂë¡£</center></b>\n";
}
...
<tr><td nowrap>&nbsp;ÃÜÂë*<td>&nbsp;<input type=password name=password value='' style="width:160px;" />&nbsp;</tr>
<tr><td colspan=2 align=center><input type=submit value='ÉÏ´«' /></tr>
</table>
</form>
<?php
}
...
<tr><td align=center>
<div id=login width=100% align=center>µÇÂ¼µ½superfastfile.com</div>
<?php
			$post['op'] = "login" ;
			$post['redirect'] = "" ;
...
<div id=info width=100% align=center>ÑéÖ¤ÉÏ´«ÓÃ»§Ãû</div>
<?php
